...
def dataMR1():
    fichero=open('./mapReducesPBD2/dataReduced/outputMR1.txt', 'r')
...
def dataMR2():
    fichero=open('./mapReducesPBD2/dataReduced/outputMR2.txt', 'r')
    lineas = fichero.readlines()
    mariadb_conexion.start_transaction()
    try:
        for linea in lineas:
...
def dataMR3():
    fichero=open('./mapReducesPBD2/dataReduced/outputMR3.txt', 'r')
    lineas = fichero.readlines()
    mariadb_conexion.start_transaction()
    try:
        for linea in lineas:
        ...
        mariadb_conexion.rollback() 
def dataMR4():
    fichero=open('./mapReducesPBD2/dataReduced/outputMR4.txt', 'r')
    lineas = fichero.readlines()
    mariadb_conexion.start_transaction()
    try:
        for linea in lineas:
        ...
        mariadb_conexion.rollback() 
def dataMR5():
    fichero=open('./mapReducesPBD2/dataReduced/outputMR5.txt', 'r')
    lineas = fichero.readlines()
    mariadb_conexion.start_transaction()
    try:
        for linea in lineas:
        ...
        mariadb_conexion.rollback() 
def dataMR6():
    fichero=open('./mapReducesPBD2/dataReduced/outputMR6.txt', 'r')
    lineas = fichero.readlines()
    mariadb_conexion.start_transaction()
    try:
        for linea in lineas:
        ...
        mariadb_conexion.rollback() 
def dataMR7():
    fichero=open('./mapReducesPBD2/dataReduced/outputMR7.txt', 'r')
    lineas = fichero.readlines()
    try:
        palabra_actual=""
        for linea in lineas:
        ...
        mariadb_conexion.rollback() 
def dataMR8():
    fichero=open('./mapReducesPBD2/dataReduced/outputMR8.txt', 'r')
    lineas = fichero.readlines()
...
def dataMR9():
    fichero=open('./mapReducesPBD2/dataReduced/outputMR9.txt', 'r')
    lineas = fichero.readlines()
    mariadb_conexion.start_transaction()
    try:
        for linea in lineas:
